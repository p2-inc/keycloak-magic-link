...
public class EmailOtpSentInEmailTest extends AbstractMagicLinkWithMailhogTest {
    ...
    public List<DynamicContainer> testEmailOtpAuthentication() throws IOException, InterruptedException, TimeoutException {
        ...
        return runCypressTests("cypress/e2e/email-otp.cy.ts", Map.of("MAILHOG_URL", "http://mailhog:8025"));
    }
