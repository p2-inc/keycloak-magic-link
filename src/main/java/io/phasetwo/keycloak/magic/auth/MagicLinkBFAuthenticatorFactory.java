...
public class MagicLinkBFAuthenticatorFactory implements AuthenticatorFactory {
  ...
  public String getDisplayType() {
    return "Magic Link Verifier";
  }

  @Override
  public String getHelpText() {
    return "Verifies a magic-link resume token inside the browser flow and authenticates the user. "
        + "Works together with the Magic Link Generator (ext-magic-form) or any backend that calls "
        + "the magic-link REST API.";
  }
